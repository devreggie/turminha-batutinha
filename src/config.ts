...
export const SiteMetadata = {
  ...
  org: {
   ...
   latlng2: [-23.548141433871027, -46.7633861932535] as [number, number],
  buildTime: new Date()
}
...
export const NavigationLinks = [
  ...
  { name: 'Sobre a Turminha', href: '/sobre-a-escolinha-tuminha-do-batutinha' },
  { name: 'Matriculas 2024', href: '/matriculas' }
]
